...
برقی دباؤ، برقی رو اور ان کی مخصوص خصلتیں اجاگر کرانے کی خاطر مختلف علامتیں استعمال کی جاتی ہیں۔ان علامتوں کو، جن سے بخوبی واقف ہونا ضروری ہے، یہاں پیش کرتے ہیں۔

\begin{description}
\item
[\عددی{V_{DD},V_{CC},V_{EE},V_{BB}}]  منبع یک سمت برقی دباؤ
\item
[\عددی{V_{BE}, V_{CE},I_D, I_C}] یک سمت برقی دباؤ اور برقی رو  (اشارہ موجود یا عدم موجود)
\item
[\عددی{V_{CEQ},I_{CQ}}]  نقطہ کارکردگی پر یک سمت برقی دباؤ اور برقی رو (اشارہ عدم موجود)
\item
[\عددی{v_d , v_{be},i_d,i_c,i_e}] بدلتا اشارہ (اوسط قیمت صفر)
\item
[\عددی{I_d, I_c,I_e,I_b} ]  سائن نما برقی رو کی مؤثر قیمت (rms)
\item
[\عددی{V_{dm},V_{cem},I_{dm},I_{cm}} ]  اشارے کی چوٹی
\item
[\عددی{v_{D},v_{BE},v_{CE},v_{BC}} ] لمحاتی برقی دباؤ
\item
...
منبع برقی دباؤ & \تحریر{voltage source}\\
منبع برقی رو & \تحریر{current source} \\
تابع منبع برقی دباؤ & \تحریر{dependent voltage source} \\
غیر تابع منبع برقی دباؤ & \تحریر{independent voltage source} \\
