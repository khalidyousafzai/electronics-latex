...
f=100:10:1000000;
plot(log10(f),log10(abs(A(f))),"linewidth",2,"color","black")

%axis
plot([log10(100),log10(1000000)],[0,0],"linewidth",1,"color","black")
plot([log10(100),log10(100)],[0,1.1*log10(abs(A(1000000)))],"linewidth",1,"color","black")
...
print -demf ktestlowCutoffFrequencyA.emf
print -deps ktestlowCutoffFrequencyA.eps
